...
- Cross-node cancellation is not implemented. Canceling a remote-target handle fails closed at the origin daemon and does not claim that the remote executor stopped.
